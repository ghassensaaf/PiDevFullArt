...
public class Chatbox2 implements Initializable {
    ...
    public void initData(int i, String ll) {
        id_client.setText(String.valueOf(i));
...
//
    ...
    private void ajouterMessage() throws SQLException {
        String sql = "INSERT into message (contenu,id_client_dest,id_artiste_exp) " +
                "values (?,?,?) ";
        try {
            preparedStatement = conn.prepareStatement(sql);
    ...
    void refresh(MouseEvent event) throws SQLException {
       ...
       artiste1=getartisteid();
        txtid_art.setText(String.valueOf(artiste1.getId_artiste()));
        Loadmsg();
        affichage.setCellFactory(param -> {
            ...
            Image img=new Image ("/image/users/salma.jpg");
            Image img2=new Image("/image/users/check.jpg");
            ...
            ListCell<message> cell = new ListCell<message>(){
                ...
                protected void updateItem(message item, boolean empty) {
                    ...
                    if(empty)
                    {
                        ...
                        if(item.getId_client_dest()<999999999 && item.getId_client_dest()>0)
                        {
    ...
    /********************************************************************************************************/
    @FXML
    private TableView<client> tb_art;

    @FXML
    private TableColumn<client, Integer> id_art;

    @FXML
    private TableColumn<client, String> Nom_art;
    ...
    private void populateTableArtiste() throws SQLException {
        ...
        id_art.setCellValueFactory(new PropertyValueFactory<>("id_client"));
    ...
    void showselectedartiste(MouseEvent event) {
        client a=tb_art.getSelectionModel().getSelectedItem();
        if(a!=null)
        {
            id_client.setText(String.valueOf(a.getId_client()));
        }
